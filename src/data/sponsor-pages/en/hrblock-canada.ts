...
export const hrblockCanadaSponsor: SponsorPageData = {
  ...
  hero: {
    tagline: 'Master the Basics of Taxes',
    introText: 'H&R Block Canada and the Industry Immersion Series are partnering to help students learn about taxes and financial literacy. Complete the March activity and you could earn a $500 micro grant.'
  },

  about: {
    title: 'About H&R Block Canada',
    description: `We're H&R Block Canada - basically, your go-to crew for all things taxes. We've got offices in nearly 1,000 communities across the country, so chances are we're not far from you.

So, what are taxes anyway?

Think of them like a contribution you make to help pay for stuff we all use - roads, schools, hospitals, etc. When you start working, you'll notice money gets taken off your paycheck. That's tax! Each year you'll file a tax return, and students get specific credits and benefits when they file. Plus, our Tax Experts know exactly what you're eligible for (that means money back in your pocket!).

We also care about giving back. We run free tax clinics through our Returning Hope program.

Whether you're filing taxes for the first time, we're here to help make the experience easy, stress-free and affordable from day one.

We're actually kinda cool on social. Hit us up on IG or TikTok @hrblockcanada for bite-sized tax tips and content that'll make adulting a little less confusing.`,
    industry: 'Tax Services & Financial Literacy',
    website: 'https://www.hrblock.ca'
  },
...
Each monthly activity is assessed against a rubric specific to that challenge. Outstanding submissions receive recognition from our industry partners along with the micro grant.`,
    hideIcon: true,
    steps: [
      'Wait for the activity to launch on **March 1st, 2026**',
      'Complete the activity following the provided instructions and rubric',
      'Submit your completed work through the submission form by **March 31st, 2026**',
  ...
  faqs: [
    ...
    {
      question: 'What if I miss the March deadline? Can I still complete the activity?',
...
<a href="https://docs.google.com/document/d/1rHxZ4QntHN0fo7rqi7uKeDQakupNtE3KtT8p3lFPur4/edit?tab=t.0" target="_blank" rel="noopener noreferrer" style="color: #0092ff; text-decoration: underline;">Click here to see the questions students are being asked</a> to answer when they submit their completed activity.`
  ...
  cta: {
    primaryLabel: 'Learn About H&R Block Canada',
    primaryUrl: 'https://www.hrblock.ca/'
  },

  meta: {
    title: 'H&R Block Canada | Industry Immersion Series Sponsor',
    description: 'Learn about taxes and financial literacy with H&R Block Canada. Complete the March activity for a chance to earn a $500 micro grant.',
