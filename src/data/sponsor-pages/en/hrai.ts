...
export const hraiSponsor: SponsorPageData = {
  ...
  hero: {
    tagline: 'Build Your Future in HVACR',
    introText: 'HVACR Career Connections powered by HRAI and the Industry Immersion Series are partnering to help students discover high-paying careers in the skilled trades. Complete the May activity and you could earn a $500 micro grant.'
  },

  about: {
    title: 'About HVACR Career Connections',
    description: `Hot Career Alert: HVACR - Heating, Ventilation, Air Conditioning & Refrigeration

Want a future where you earn while you learn, fix things with purpose, and help keep people comfy all year long?

HVACR is more than just tools and ductwork - it's a high-paying, in-demand trade with paths into design, engineering, sales, green tech, even owning your own business.

With earnings up to $125,000 plus and apprenticeship programs that pay while you train, HVACR is where opportunity meets action.

Dare to build your future - literally. Start building here www.hvacrcareers.ca`,
    industry: 'HVACR Skilled Trades',
    website: 'https://www.hvacrcareers.ca'
  },

  partnership: {
    description: `In May 2026, HVACR Career Connections powered by HRAI is sponsoring a skill-building activity where you'll explore careers in the HVACR trades, develop relevant skills, and create content that showcases what you've learned.

**Starting May 1st, 2026**, complete the activity and submit your work for a chance to be one of 20 students selected to receive a $500 micro grant.
...
Each monthly activity is assessed against a rubric specific to that challenge. Outstanding submissions receive recognition from our industry partners along with the micro grant.`,
    hideIcon: true,
    steps: [
      'Wait for the activity to launch on **May 1st, 2026**',
      'Complete the activity following the provided instructions and rubric',
      'Submit your completed work through the submission form by **May 31st, 2026**',
  ...
  faqs: [
    ...
    {
      question: 'What if I miss the May deadline? Can I still complete the activity?',
    ...
    },
    {
      ...
      answer: 'You can\'t earn more than one micro grant within the same month; however, you can earn multiple micro grants across different months. For example, you could earn a micro grant in November and again in May. There\'s no maximum number of micro grants you can earn.'
    },
    {
...
<a href="https://docs.google.com/document/d/1rHxZ4QntHN0fo7rqi7uKeDQakupNtE3KtT8p3lFPur4/edit?tab=t.0" target="_blank" rel="noopener noreferrer" style="color: #0092ff; text-decoration: underline;">Click here to see the questions students are being asked</a> to answer when they submit their completed activity.`
  ...
  cta: {
    primaryLabel: 'Explore HVACR Careers',
    primaryUrl: 'https://www.hvacrcareers.ca'
  },

  meta: {
    title: 'HVACR Career Connections | Industry Immersion Series Sponsor',
    description: 'Discover high-paying careers in the HVACR skilled trades. Complete the May activity for a chance to earn a $500 micro grant.',
