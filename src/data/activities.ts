...
// Months that are live and navigable from the timeline
export const liveActivityMonths = ['october', 'november', 'december', 'january', 'february', 'march', 'april', 'may-1', 'may-2'];
