...
export const novemberActivity: ActivityPageData = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Oui, vous pouvez quand même soumettre des activités mensuelles après la date limite. Toutefois, toute activité soumise après la date limite n\'est pas admissible à la réserve de micro-subventions de ce mois-là.`
    },
    {
