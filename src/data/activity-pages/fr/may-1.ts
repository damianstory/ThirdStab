...
export const may1Activity: ActivityPageData = {
  ...
  month: 'mai-1',
  year: '2026',
  title: 'Défi de l\'industrie CVCA (chauffage, ventilation, climatisation et réfrigération)',
  description: 'Le CVCA, ce n\'est pas seulement des outils et des conduits : c\'est un métier spécialisé bien rémunéré et en forte demande, qui offre des possibilités en conception, en ingénierie, en vente, en technologies vertes et même en entrepreneuriat.',
  sponsor: {
    name: 'HRAI',
  ...
  hero: {
    ...
    introText: `Le chauffage, la ventilation, la climatisation et la réfrigération (CVCA) permettent aux maisons, aux écoles, aux hôpitaux et aux entreprises de fonctionner de façon sécuritaire et efficace. Il s'agit d'un secteur en pleine croissance et à l'épreuve de l'IA, où la demande de main-d'œuvre qualifiée est forte partout au Canada pour une vaste gamme de métiers.\n\nDans ce défi, tu exploreras une entreprise réelle de CVCA dans ta communauté, tu en apprendras davantage sur un métier précis du secteur et tu verras comment les technologies CVCA améliorent l'efficacité énergétique et réduisent l'impact environnemental.\n\nAu fil du défi, tu découvriras des parcours professionnels concrets et en forte demande auxquels tu n'avais peut-être pas pensé.`
  },

  video: {
    embedUrl: 'https://www.youtube.com/embed/IBeLJ33OCoc',
    title: 'À propos des carrières en CVCA',
    description: `Regardez cette vidéo pour découvrir comment les carrières en CVCA combinent le travail pratique, la résolution de problèmes et des technologies en constante évolution. Des métiers spécialisés, comme mécanicien en chauffage au gaz, en climatisation ou en réfrigération, jusqu'à la conception de systèmes, à la vente ou même au démarrage de votre propre entreprise, le CVCA offre une grande variété de parcours professionnels.\n\nDe nombreux parcours reposent sur l'apprentissage, ce qui vous permet de gagner un revenu tout en apprenant et de développer des compétences recherchées partout au Canada.`
  },
  ...
  activityDetail: {
    description: `Le Canada a besoin de plus de professionnels qualifiés en CVCA pour répondre à la croissance des besoins en construction, en entretien et en efficacité énergétique. Par exemple, on estime que la demande pour les mécaniciens en climatisation et en réfrigération augmentera de 400 % au cours des 10 prochaines années.\n\n<strong>Dans ce défi, vous devrez :</strong>\n<ul style="list-style-type: disc; padding-left: 1.5rem; margin-top: 0.5rem;"><li>effectuer des recherches sur une entreprise réelle de CVCA dans votre communauté</li><li>explorer un métier précis dans cette entreprise ou dans l'industrie</li><li>découvrir comment les technologies CVCA contribuent à l'efficacité énergétique et à la performance des bâtiments</li><li>comprendre les perspectives d'emploi et la demande future dans ce domaine</li></ul><p style="margin-top: 1rem;">Concentrez-vous sur des informations claires et fiables provenant de sources crédibles. Évitez de copier des définitions générales — montrez ce que vous avez appris avec vos propres mots.</p>`,
    steps: [
      {
        title: "Étape 1 : Recherchez une entreprise de CVCA locale",
        details: `<strong>Trouvez et présentez au moins une entreprise réelle de CVCA dans votre communauté.</strong>
...
• effectuez une recherche en ligne sur les entreprises de CVCA dans votre région
• demandez à votre entourage
• utilisez les ressources de HRAI ci-dessous

<strong>Objectif :</strong>
Montrer que le CVCA est une industrie bien présente localement, offrant de véritables possibilités d'emploi partout au Canada, y compris dans votre communauté.`
      },
      {
        title: "Étape 2 : Découvrez un métier en CVCA",
        details: `<strong>Choisissez un métier en CVCA et découvrez à quoi il ressemble concrètement.</strong>
...
<strong>Bonus :</strong>
Si vous pouvez échanger avec une personne du domaine, même brièvement, ajoutez ce que vous avez appris.

<strong>Exemples de métiers à explorer :</strong>
Technicien en installation ou en entretien CVCA (résidentiel ou commercial), ferblantier, estimateur, gestionnaire de service, concepteur de systèmes ou spécialiste des ventes.`
      },
      {
        title: "Étape 3 : Technologie et impact environnemental",
        details: `<strong>Expliquez une technologie en CVCA et son importance.</strong>

Choisissez une technologie, par exemple :
• les thermopompes
• les systèmes CVCA intelligents ou automatisés
• les systèmes de réfrigération et les réfrigérants modernes
• les systèmes de ventilation pour la qualité de l'air intérieur

Puis expliquez :
• comment elle fonctionne (de façon simple)
• comment elle améliore le confort et l'efficacité
...
Pourquoi cette transition augmente-t-elle la demande de main-d'œuvre qualifiée?`
      },
      {
        ...
        details: `<strong>Explorez la demande d'emploi et les possibilités de carrière en CVCA.</strong>
...
<strong>Objectif :</strong>
Montrer que le CVCA offre des perspectives de carrière concrètes, maintenant et à l'avenir.`
      },
      {
...
Assurez-vous que votre lien est accessible (testez-le en mode navigation privée) avant de le soumettre.`
  ...
  rubric: {
    criteria: [
      ...
      },
      {
        ...
        weight: 25,
        description: 'Organisation logique, fluidité et qualité audio/visuelle, avec respect de la durée'
      },
      {
  ...
  submission: {
    ...
    instructions: 'Soumettez votre vidéo pour le défi de mai sur le CVCA. Assurez-vous que votre lien est accessible (testez-le en mode navigation privée) avant de soumettre.'
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Vous devez soumettre une vidéo de 90 à 120 secondes mettant en valeur la recherche que vous avez réalisée aux étapes 1 à 4. Votre vidéo devrait couvrir : une entreprise locale de CVCA, un métier précis, une technologie CVCA et son impact environnemental, ainsi que la demande future de professionnels en CVCA. Assurez-vous que le lien de votre vidéo est accessible — testez-le dans une fenêtre de navigation privée avant de soumettre votre projet.`
    },
    {
      question: 'Puis-je soumettre plus d\'une vidéo?',
      answer: `Oui, vous pouvez réaliser l'activité plusieurs fois en explorant différentes entreprises ou différents métiers en CVCA, mais chaque élève ne peut gagner qu'une seule microbourse par activité. Nous vous encourageons à privilégier la qualité plutôt que la quantité.`
    },
    {
    ...
    },
    {
      ...
      answer: `Le Défi de l'industrie CVCA a été conçu comme une activité individuelle.`
    },
    {
  ...
  resources: [
    {
      title: 'Quiz de découverte des carrières en CVCA',
      description: 'Faites ce quiz pour découvrir quel parcours de carrière en CVCA pourrait vous convenir.',
    ...
    {
      title: 'Carrières en CVCA',
      description: 'Explorez les parcours, les rôles et les possibilités de carrière dans l\'industrie du CVCA partout au Canada.',
    ...
    },
    {
      ...
      description: 'Trouvez les entrepreneurs et les entreprises CVCA de votre région grâce au répertoire de HRAI.',
    ...
    {
      title: 'Une journée dans la vie d\'un technicien CVCA',
      description: 'Une courte vidéo qui montre à quoi ressemble une journée typique pour un technicien CVCA.',
    ...
    },
    {
      ...
      description: 'Suivez HVACJess pour découvrir la réalité du métier de professionnel CVCA.',
    ...
    {
      title: 'HRAI',
      description: 'Apprenez-en davantage sur l\'Institut canadien du chauffage, de la climatisation et de la réfrigération et sur l\'industrie du CVCA.',
    ...
    },
    {
      ...
      description: 'Découvrez les engagements climatiques de HRAI et le rôle de l\'industrie du CVCA dans les objectifs environnementaux du Canada.',
    ...
    {
      title: 'Guichet-Emplois : perspectives pour les mécaniciens CVCA',
      description: 'Consultez les perspectives d\'emploi, les salaires et les tendances du marché du travail pour les mécaniciens CVCA partout au Canada.',
  ...
  resourcesSubtitle: 'Utilisez ces ressources pour appuyer vos recherches sur les carrières et les entreprises en CVCA.',

  meta: {
    title: 'Défi de l\'industrie CVCA – mai 2026 | Série d\'immersion dans l\'industrie',
    description: 'Faites des recherches sur une entreprise locale de CVCA, découvrez un métier en demande et explorez comment les technologies CVCA contribuent à l\'avenir plus écologique du Canada. Courez la chance de gagner jusqu\'à 500 $ en microbourses avec HRAI.',
