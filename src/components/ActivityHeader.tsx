...
export default function ActivityHeader() {
  ...
  // Activity-specific navigation items (scroll to sections on current page)
  const navigation = isLoading ? [] : [
    { name: t('header.activityNavigation.howToSubmit'), href: '#activity-details' },
    { name: t('header.activityNavigation.resources'), href: '#sponsor-resources' },
    { name: t('header.activityNavigation.faq'), href: '#activity-faq' },
  ];
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    ...
    if (element) {
      ...
      const additionalOffset = 10; // Extra breathing room
